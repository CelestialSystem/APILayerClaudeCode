import {
    Box, Button, FormControl, FormControlLabel, FormLabel, IconButton,
                ...
                <Box className={classes.signupBox}>
                    <Box className={classes.TopBoxBtns}>
                        ...
                        <Box className={classes.signUpBtns}>
                            <Button disableRipple startIcon={<GithubIcon />}>Sign up with Github</Button>
                            <Button disableRipple startIcon={<GoogleIcon />}>Sign up with Google</Button>
                        </Box>
                    </Box>
                    ...
                    <form className={classes.form}>
                        <Box>
                            <FormControl className={classes.formControl}>
                                ...
                                <TextField type='email' id='emailField' name='email' placeholder='Enter email' />
                                <Box className={classes.errorRow}>
                                    <ErrorOutlineOutlinedIcon />
                                    <Typography variant="h5">Email already exist, login instead</Typography>
                                </Box>
                            </FormControl>
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <Typography component="span" fontSize={14}>
                                    ...
                                    <Link href="" underline="none">Terms of Use{' '}</Link>&amp; {' '}Privacy Statement
                                </Typography>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <Typography component="span">
                                    {!expanded ? (
                                        ...
                                        <>
                                            I agree to receive marketing communication from APILayer for
                                            product updates, sales services, promotions, news, and events.
                                            I can withdraw my consent at any time and update my communication
                                            preferences at the subscription center from any email received.{' '}
                                            <Link href="#" underline="none" onClick={handleToggle}>
                                                Read less
                                            </Link>
                                        </>
                        ...
                        >
                            ...
                            >
                                ...
                                <Box className={classes.planPriceContainer}>
                                    <Typography variant="h1" component="span" className={classes.planPrice}>
                                        {plan.price}
                                    </Typography>
                                    <Typography component="span" className={classes.planPriceUnit}>
                                        {plan.priceUnit}
                                    </Typography>
                                </Box>
                            </Box>
