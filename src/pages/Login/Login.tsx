import {
    Box, Button, FormControl, FormLabel, IconButton,
            ...
            <Box className={classes.loginBox}>
                <Box className={classes.TopBoxBtns}>
                    ...
                    <Box className={classes.signInBtns}>
                        <Button disableRipple startIcon={<GithubIcon />}>Sign in with Github</Button>
                        <Button disableRipple startIcon={<GoogleIcon />}>Sign in with Google</Button>
                    </Box>
                </Box>
                ...
                <Box className={classes.errorPlaceholderBox}>
                    ...
                    {isError &&
                        <Box className={classes.errorRow}>
                            ...
                            <Typography variant="h5">Email or password is incorrect</Typography>
                ...
                <form className={classes.form}>
                    ...
                    <FormControl className={classes.formControl}>
                        ...
                        <TextField type={showPassword ? 'text' : 'password'} id='passwordField' name='password'
                            placeholder='Enter password' InputProps={{
                                endAdornment: (
                    ...
                    <Link href="" className={classes.Link} sx={{ display: 'inline-block', marginTop: '4px' }}>Forgot Password?</Link>

                    <Box className={classes.loginBtnBox}>
                        <Button type='submit' disableRipple className={classes.logInBtn}>
                            Login
                        </Button>
